...
-- System
hl.bind(mod .. " + CTRL + Escape", hl.dsp.exec_cmd("~/.config/hypr/scripts/powermenu.sh"))
hl.bind(moon .. " + p",            hl.dsp.exec_cmd("~/.config/hypr/scripts/powermenu.sh"))
...
hl.bind(mod .. " + SHIFT + equal",     hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"))
